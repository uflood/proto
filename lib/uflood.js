define(['leaflet', 'knn', 'entrypoints', 'gmaps', 'jquery', 'basemap'], function(L, knn, ep, gmaps, $, basemap){
    ...
    return {
        local: function(event, n){
            ...
            function getnext(id, seen) {
                ...
                // Dedham
                if (id == 901) {
                    return {here: new gmaps.LatLng(42.2447835, -71.1812346), next: null}
                }

                // Newton
                if (id == 902) {
                    return {here: new gmaps.LatLng(42.3253729, -71.2136779), next: null}
                }

                // Watertown
                if (id == 903) {
                    return {here: new gmaps.LatLng(42.3721351, -71.1786435), next: null}
                }

                // Milton
                if (id == 904) {
                    return {here: new gmaps.LatLng(42.2465443, -71.0713179), next: null}
                }
